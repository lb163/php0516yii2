		...
		<div class="goods_content fl mt10 ml10">
			...
			<div class="summary">
				...
				<div class="preview fl">
					<div class="midpic">
						<a href="<?=str_replace('/upload','http://admin.yii2shop.com/upload',$gallerys[0]->path)?>" class="jqzoom" rel="gal1">
							<img src="<?=str_replace('/upload','http://admin.yii2shop.com/upload',$gallerys[0]->path)?>" alt="" width="350"/>
						</a>
					...
					<?php /*foreach ($model1 as $value):*/?><!--
						<li class="cur">
							<a class="zoomThumbActive" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '/images/preview_m1.jpg',largeimage: '/images/preview_l1.jpg'}">
								<img src="<?/*='http://admin.yii2shop.com'.$value->path*/?>"></a>
						</li>
					--><?php /*endforeach;*/?>
...
<!--								</li>-->
								<?php foreach ($gallerys as $value):?>
									<li class="cur">
										<a class="zoomThumbActive" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '/images/preview_m1.jpg',largeimage: '/images/preview_l1.jpg'}">
											<img src="<?=str_replace('/upload','http://admin.yii2shop.com/upload',$gallerys[0]->path)?>"></a>
									</li>
								<?php endforeach;?>
<!--								<li>-->
			...
			<div class="detail">
				...
				<div class="detail_bd">
					...
					<div class="introduce detail_div none">
						<div class="attr mt15">
							<ul>
								<li><span>商品名称：</span>小姐姐</li>
								<li><span>商品编号：</span><?=$model->sn?></li>
								<li><span>身高：</span>178.cm</li>
								<li><span>上架时间：</span><?=date('Y-m-d',$model->create_time)?></li>
								<li><span>体重：</span>55kg</li>
								<li><span>出生地：</span>中国四川</li>
							</ul>
						</div>
