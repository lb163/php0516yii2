            ...
            <ul>
                <li>您好，欢迎来到京西！
                    <?php if(Yii::$app->user->isGuest):?>
                        ...
                        [<?=\yii\helpers\Html::a('免费注册',['register'])?>]
                    <?php else:?>
                        [<?=\yii\helpers\Html::a('注销',['logou'])?>]
                    <?php endif;?>
                </li>
               ...
               <?php foreach ($admin as $row): ?>
                ...
                <div class="cat">
                    ...
                    <div class="cat_detail">
                        <?php foreach ($row->children(1)->all() as $row2):?>
                        <dl>
                            <dt><a href="<?=\yii\helpers\Url::to(['list'])?>"><?=$row2->name?></a></dt>
                            <dd>
                                <?php foreach ($row2->children(2)->all() as $row3): ?>
                                <a href="<?=\yii\helpers\Url::to(['list','category_id'=>$row3->id])?>"><?=$row3->name?></a>
                                <?php endforeach; ?>
                            </dd>
                        </dl>
                        <?php endforeach;?>
